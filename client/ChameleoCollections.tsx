...
import { Collection } from '@/services/chameleoApi';
import { ChevronDown, ChevronUp, RefreshCw, Grid, List } from 'lucide-react';
import { Link } from 'react-router-dom';
import CustomCategoryCollection from '@/components/CustomCategoryCollection';
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="flex flex-col">
                <CustomCategoryCollection categoryHandle="sport" title="SPORT" />
                <Link 
                  to="/chamelo-catalog?collection=sport" 
                  className="text-xs uppercase hover:underline mt-4"
                >
                  See All Sport Products
                </Link>
              </div>
              {/* LIFESTYLE */}
              <div className="flex flex-col">
                <CustomCategoryCollection categoryHandle="lifestyle" title="LIFESTYLE" />
                <Link 
                  to="/chamelo-catalog?collection=lifestyle" 
                  className="text-xs uppercase hover:underline mt-4"
                >
                  See All Lifestyle Products
                </Link>
              </div>
              {/* PRISMATIC */}
              <div className="flex flex-col">
                <CustomCategoryCollection categoryHandle="prismatic" title="PRISMATIC" />
                <Link 
                  to="/chamelo-catalog?collection=prismatic" 
                  className="text-xs uppercase hover:underline mt-4"
                >
                  See All Prismatic Products
                </Link>
              </div>
            </div>
          </div>
