-- Migration complète vers un schéma propre et relationnel (version corrigée 2)
...
-- 18. Calculer le prix des variants (base + modifier) - version corrigée
UPDATE product_variants 
SET price = (
  SELECT p.price_base + COALESCE(product_variants.price_modifier, 0)
  FROM products p 
